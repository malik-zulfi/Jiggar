...
export default function CvDisplay({
  ...
  structuredContent: StructuredCvContent;
}) {
  if (!structuredContent) {
    return (
      <p className="text-muted-foreground">No structured content available.</p>
    );
  }

  const { summary, experience, education, skills, projects } =
    structuredContent;
