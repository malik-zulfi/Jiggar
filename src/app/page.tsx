                        ...
                        <div className="lg:col-span-1 flex flex-col gap-6">
                            <Card className="shadow-sm">
                                ...
                                <CardContent className="flex flex-col gap-4">
                                    ...
                                    {hasActiveFilters && (
                                        <Button variant="ghost" onClick={resetFilters} className="self-start">
                                ...
                                <CardContent>
                                    {stats.chartDataByCode.length > 0 ? (
                                        <ChartContainer config={chartConfig} className="h-[250px] w-full">
                                            <BarChart data={stats.chartDataByCode} layout="vertical" margin={{ right: 20, left: 20 }}>
                            ...
                            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                                <Card className="shadow-sm">
                                    ...
                                    <CardContent>
                                        ...
                                        <p className="text-xs text-muted-foreground">Total unique jobs analyzed</p>
                                    </CardContent>
                                </Card>
                                <Card className="shadow-sm">
                                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                ...
                                <Card className="shadow-sm">
                                    ...
                                    <CardContent>
                                        ...
                                        <p className="text-xs text-muted-foreground">Total unique CVs</p>
                                    </CardContent>
                                </Card>
                                <Card className="shadow-sm">
                                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    ...
                                    <CardContent>
                                        ...
                                        <p className="text-xs text-muted-foreground">Candidates to be assessed</p>
                                    </CardContent>
                                </Card>
                            </div>
                            <Card className="shadow-sm">
